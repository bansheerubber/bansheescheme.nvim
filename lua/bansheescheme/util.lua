local ts = require("bansheescheme.treesitter")
...
function M.invert_color(color)
  local hsluv = require("bansheescheme.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("bansheescheme", { clear = true })
...
function M.load(theme)
  ...
  vim.g.colors_name = "bansheescheme"
