...
function M.setup()
  ...
  for extra, info in pairs(M.extras) do
    package.loaded["bansheescheme.extra." .. extra] = nil
    local plugin = require("bansheescheme.extra." .. extra)
    for style, style_name in pairs(styles) do
      config.setup({ style = style })
      local colors = require("bansheescheme.colors").setup({ transform = true })
      local fname = extra .. "/bansheescheme" .. style .. "." .. info.ext
      colors["_upstream_url"] = "https://github.com/bansheerubber/bansheescheme.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "bansheescheme" .. style_name
